 ...
 *
 * @description
 * For convenience, if the image is undefined, this function returns true.
 *
 * @param {Object} drive - drive
...
exports.isDriveLargeEnough = (drive, image) => {
  return _.get(image, 'size', 0) <= drive.size;
};
 ...
 *
 * @description
 * For convenience, if either the image is undefined, or the image doesn' have
 * a recommended size, this function returns true.
 *
 * @param {Object} drive - drive
 * @param {Object} image - image
...
exports.isDriveSizeRecommended = (drive, image) => {
  return drive.size >= _.get(image, 'recommendedDriveSize', 0);
};
