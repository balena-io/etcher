...
module.exports = {
  ...
  error: {
    ...
    writerTimeout: _.template([
      'The writer process timed out after <%= timeout %>s.',
      'We can\'t guarantee the drive was completely written nor verify its data is correct, please try again.'
    ].join(' '))
