...
/**
 * @summary Find a device by its device field
 * @function
 * @public
 *
 * @param {String} driveDevice - drive device identifier
 * @returns {Object|undefined} drive object, or undefined
 *
 * @example
 * const drive = availableDrives.findnDriveByDevice('/dev/sdb')
 */
exports.findDriveByDevice = (driveDevice) => {
