...
exports.setDrives = (driveDevices) => {
  exports.clear({
    preserveImage: true
  })

  _.map(driveDevices, exports.toggleDrive)
}
 ...
 *
 * @example
 * const selectedDevices = selectionState.getSelectedDevices()
 */
...
exports.getSelectedDrives = () => {
  return _.map(exports.getSelectedDevices(), availableDrives.findDriveByDevice)
}
