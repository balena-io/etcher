  ...
  if (!elevated || !process.env.ETCHER_RUNNING) {
    ...
    return permissions.elevateCommand(commandArguments, {
      ...
      environment: {
        ...
        // TODO: This flag shouldn't be necessary
        // Signal that Etcher is already running, so the writer shouldn't
        // try to spawn any more instances, and also knows it's a writer.
        ETCHER_RUNNING: 1,
