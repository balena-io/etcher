...
SelectionStateModel.service('SelectionStateModel', function(DrivesModel) {
  ...
  /**
   * @summary Get image instructions
   * @function
   * @public
   *
   * @returns {String} image instructions
   *
   * @example
   * const imageInstructions = SelectionStateModel.getImageInstructions();
   */
  this.getImageInstructions = () => {
    return _.get(Store.getState().toJS(), 'selection.image.instructions');
  };
