...
module.exports = function($state, SelectionStateModel) {
  ...
  /**
   * @summary Set the `shouldShowWebview` property
   * @function
   * @public
   *
   * @param {Boolean} bool - preserve image
   *
   * @example
   * FinishController.setShowWebview(true);
   */
  this.setShowWebview = (bool) => {
    this.shouldShowWebview = bool;
  };
