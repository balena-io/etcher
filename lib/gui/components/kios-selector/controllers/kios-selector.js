...
module.exports = function($uibModalInstance, KiOSModel, SelectionStateModel) {
  ...
  this.showDevices = (device) => {
    ...
    var assets = _.map(device.assets, function(element) { 
     return _.extend({}, element, {tag_name: device.tag_name});
    });
