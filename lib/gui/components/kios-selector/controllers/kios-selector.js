...
module.exports = function($uibModal, $uibModalInstance, KiOSModel, SelectionStateModel) {
  ...
  this.showDevices = (release) => {
    ...
    var assets = _.map(release.assets, function(element) { 
     return _.extend({}, element, {tag_name: release.tag_name});
    });
  ...
  this.setConnection = (connection) => {
    this.connection = connection.ssid;
    this.networkType['connection'] = (connection.ssid == "x - not in this list") ? 'other' : connection.ssid;
  }
  ...
  this.setNetworkTypeState = () => {
    this.networkType['connection'] = this.wifi_connection;
    this.networkType['password'] = this.wifi_password;
