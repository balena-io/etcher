 ...
 */
var DriveScanner, DynamicList, Promise, _, chalk, rp, async, connectionToChoice, checkForGoodConnections, scanner;
...
scanner = Promise.promisifyAll(require('node-wifi-scanner'));
...
exports.getConnections = function()
{
    ...
    .then((networks) => {
      var connections = checkForGoodConnections(networks);
      return connections;
    })
    .catch((error) => {
        return [];
