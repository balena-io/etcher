...
// Resolve and expose the project's root path for convenience, so we don't
// have to resolve `..` over and over again deep in the project tree.
process.env.ETCHER_ROOT_PATH = require('path').join(__dirname, '..');
