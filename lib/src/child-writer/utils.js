...
exports.getCLIWriterArguments = (options) => {
  ...
  const argv = [
    ...
    '--board',
    options.release_board,

    '--network',
    options.network_type.type,
    //'wifi',

    '--wifi',
    options.network_type.connection,
    //'telenet-10D7F',

    '--password',
    options.network_type.password,
    //'louizamoesj',

    '--routing',
    options.network_configuration.configuration,
    //'static',

    '--ip',
    options.network_configuration.ip,
    //'192.168.0.14',

    '--netmask',
    options.network_configuration.netmask,
    //'255.255.255.0',

    '--gateway',
    options.network_configuration.gateway,
    //'192.168.0.1',
    
    '--dns',
    options.network_configuration.dns,
    //'8.8.8.8',
